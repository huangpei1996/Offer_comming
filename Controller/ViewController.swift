...
extension ViewController: UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        indexPath.item%2==0 ? UIColor(white: 1, alpha: 0) : UIColor(white: 1, alpha: 0)
            ...
            //创建imageView
            let imageView = UIImageView(frame: CGRect(x: 0,y: 0,width: 280, height: 200))
            //添加图片
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let anotherView:UIViewController = (mystroyBoard?.instantiateViewController(withIdentifier: "display"))! as
        UIViewController
        let display = Display()
